...
$aColumns = array("rowNumber","img","Actions");
			...
			SELECT
				...
				(
					SELECT
						...
						CONCAT('<img style=\"height: 100px;\" src=\"../images/carousal/',`slider`.`images`,'\" >') as `img`,

						CONCAT('<div class=\"margin-bottom-5\">

						" . ((in_array(13, $assignedmenuedit) || $result['roleId'] == 0) ? "<a href=\"../addcarousal-',TO_BASE64(`slider`.`imageId`),'/\" style=\"width: 30px;height: 30px;margin-right:5px;\" title=\"Edit\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-success\"><i class=\"fas fa-edit\"></i></a>" : "") . "
                        
                        " . ((in_array(13, $assignedmenudelete) || $result['roleId'] == 0) ? "<button onclick=\"remove(',`slider`.`imageId`,')\" style=\"width: 30px;height: 30px;\" title=\"Delete\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-danger\"><i class=\"fas fa-trash\"></i></button>" : "") . "
						...
						FROM `slider` where `type`= 'slider' && `delete`= '0'
