...
$aColumns = array("rowNumber", "Actions", "name");
			...
			SELECT
				...
				(
					SELECT
                        ...
                        " . ((in_array(26, $assignedmenuedit) || $result['roleId'] == 0) ? " <a href=\"../addlanguage-',TO_BASE64(`language`.`languageId`),'/\" style=\"width: 30px;height: 30px;margin-right:5px;\" title=\"Edit\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-success\"><i class=\"fas fa-edit\"></i></a>" : "") . "
                        
                        " . ((in_array(26, $assignedmenudelete) || $result['roleId'] == 0) ? "<button onclick=\"remove(',`language`.`languageId`,')\" style=\"width: 30px;height: 30px;\" title=\"Delete\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-danger\"><i class=\"fas fa-trash\"></i></button>" : "") . "
                        
                        
                        </div>') AS `Actions`
						
						FROM `language` where `language`.`delete`= '0'
