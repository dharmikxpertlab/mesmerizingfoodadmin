...
$values=$viewtutor["specialityDish"] == null ? 0 : $viewtutor["specialityDish"];


$var = trim($values,$charlist);


$aColumns = array("rowNumber","dishName","Actions");
			...
			SELECT
				...
				(
					...
					`dishes`.`dishName`,
                        ...
                        <button onclick=\"editDish(',`dishes`.`dishId`,',\'',`dishes`.`dishName`,'\')\" style=\"width: 30px;height: 30px;\" title=\"Delete\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-success\"><i class=\"fa fa-edit\"></i></button>"  . "
						...
						where `dishes`.`delete`= '0' AND `dishId` IN (".$var .")
