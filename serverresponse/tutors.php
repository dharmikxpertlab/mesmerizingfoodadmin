...
// "gender","languages",
$aColumns = array("rowNumber","Actions","fullName","contact","location","courseType","experienceYear");
			...
			SELECT
				...
				(
					...
					`chef`.`countryCode`,' ',`chef`.`mobileNumber` ) as contact,
						...
						CONCAT(`chef`.`fullName`,
						CASE
						WHEN `chef`.`rating` = 5
						THEN '<div class=\"form-group row\">
                        <div class=\"col-lg-12\">
						...
						CONCAT('<div class=\"margin-bottom-5\"><a href=\"../addtutors-',TO_BASE64(`chef`.`chefId`),'/\" style=\"width: 30px;height: 30px;margin-right:5px;\" title=\"Edit\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-success\"><i class=\"fas fa-edit\"></i></a>

						<a href=\"../viewtutor-',TO_BASE64(`chef`.`chefId`),'/\" style=\"width: 30px;height: 30px;margin-right:5px;\" title=\"Edit\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-icon btn-warning\"><i class=\"fas fa-eye\"></i></a>

						<button onclick=\"remove(',`chef`.`chefId`,')\" style=\"width: 30px;height: 30px;\" title=\"Delete\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-danger\"><i class=\"fas fa-trash\"></i></button>
						</div>
						') AS `Actions`
						
						FROM `chef` WHERE `delete` = '0'
