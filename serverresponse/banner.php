			...
			SELECT
				...
				(
					SELECT
						...
						" . ((in_array(14, $assignedmenuedit) || $result['roleId'] == 0) ? "<a href=\"../addbanner-',TO_BASE64(`slider`.`imageId`),'/\" style=\"width: 30px;height: 30px;margin-right:5px;\" title=\"Edit\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-success\"><i class=\"fas fa-edit\"></i></a>" : "") . "
                        
                        " . ((in_array(14, $assignedmenudelete) || $result['roleId'] == 0) ? "<button onclick=\"remove(',`slider`.`imageId`,')\" style=\"width: 30px;height: 30px;\" title=\"Delete\" data-toggle=\"tooltip\" data-theme=\"dark\" data-placement=\"right\" class=\"btn btn-icon btn-danger\"><i class=\"fas fa-trash\"></i></button>" : "") . "
						...
						FROM `slider` where `type`= 'add' && `delete`= '0'
