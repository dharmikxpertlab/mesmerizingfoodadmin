...
<?php
$getQuery = mysqli_query($connection, "SELECT * FROM `content` WHERE `contentId`='2'");
...
if (isset($_POST['tnc'])) {
    ...
    $insertQuery = mysqli_query($connection, "UPDATE `content` SET `contentData`='" . $termsAndConditions . "' WHERE `contentId`=2");
    header("location:../privacypolicy/");
}
?>
...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <button class="btn btn-primary font-weight-bolder" id="editpvc" name="edit">
                Edit
            </button>
    ...
    <form class="form" id="tnc" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control form-control-solid" id="demo-editor-bootstrap" name="terms" rows="25"> <?php if (isset($tnc)) {
                                                                                                                            echo $tnc;
                                                                                                                        } ?> </textarea>
            </div>
