...
<?php
$getQuery = mysqli_query($connection, "SELECT * FROM `content` WHERE `contentId`='1'");
...
if (isset($_POST['tnc'])) {
    ...
    $insertQuery = mysqli_query($connection, "UPDATE `content` SET `contentData`='" . $termsAndConditions . "' WHERE `contentId`=1");
